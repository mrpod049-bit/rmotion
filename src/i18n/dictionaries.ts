...
const fr = {
  ...
  machine: {
    ...
    stockValue: "Fabrication à la commande",
    stockTail: "délai 45 / 60 jours",
  ...
  newsletter: {
    ...
    sending: "Envoi…",
    successTitle: "Merci !",
    successText: "Votre inscription est bien enregistrée.",
    error: "Une erreur est survenue, veuillez réessayer.",
    emailInvalid: "Adresse email invalide.",
    consentRequired: "Merci de cocher la case de consentement.",
    close: "Fermer",
  },
  articles: {
    metaTitle: "Articles",
  ...
  devis: {
    ...
    metaDesc:
      "Contactez Rmotion pour un devis sur votre machine laser fibre ou centre d'usinage CNC, ou pour toute question technique ou généraliste. Réponse sous 48h.",
    title: "Formulaire de contact",
    subtitle:
      "Pour nous contacter, veuillez remplir ce formulaire avec vos coordonnées. Un membre de notre équipe reviendra vers vous dans un délai de 48h. En cas de question généraliste, veuillez laisser le champ « Machine concernée » vide.",
    requestTypeLabel: "Type de demande",
    requestTypeQuote: "Demande de devis",
    requestTypeGeneral: "Questions généralistes / techniques",
    name: "Nom *",
    company: "Société",
    email: "Email *",
    phone: "Téléphone",
    ...
    error: "Une erreur est survenue, veuillez réessayer.",
    contactHeading: "Contactez-nous directement",
...
const en: Dictionary = {
  ...
  newsletter: {
    ...
    successText: "Your subscription is confirmed.",
    error: "Something went wrong, please try again.",
    emailInvalid: "Invalid email address.",
    consentRequired: "Please tick the consent box.",
    close: "Close",
  },
  articles: {
    metaTitle: "Articles",
  ...
  devis: {
    ...
    metaDesc:
      "Contact Rmotion for a quote on your fiber laser machine or CNC machining centre, or for any technical or general question. Reply within 48h.",
    title: "Contact form",
    subtitle:
      "To contact us, please fill in this form with your details. A member of our team will get back to you within 48 hours. For a general question, please leave the “Machine of interest” field empty.",
    requestTypeLabel: "Request type",
    requestTypeQuote: "Quote request",
    requestTypeGeneral: "General / technical questions",
    name: "Name *",
    company: "Company",
    email: "Email *",
    phone: "Phone",
