...
-- Photos des machines
UPDATE machines SET images = ARRAY['/gammes/laser-1.jpg']::text[] WHERE slug = 'scl-series';
UPDATE machines SET images = ARRAY['/gammes/laser-2.jpg']::text[] WHERE slug = 'bcl-series';
UPDATE machines SET images = ARRAY['/gammes/laser-4.jpg']::text[] WHERE slug = 'ol-series';
UPDATE machines SET images = ARRAY['/gammes/cnc-3.jpg']::text[] WHERE slug = 'mcs-series';
UPDATE machines SET images = ARRAY['/gammes/cnc-1.jpg']::text[] WHERE slug = 'mr-series';
UPDATE machines SET images = ARRAY['/gammes/cnc-2.jpg']::text[] WHERE slug = 'scs-series';
